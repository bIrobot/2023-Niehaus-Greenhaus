...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kLiftArmSpeed = 1;
    public static final double kLowerArmSpeed = -1;
    public static final double kStopArmSpeed = 0;
    public static final double kStopClawSpeed = 0;
